...
public class KeyspaceManagerRegular implements KeyspaceManager {
  ...
  public KeyspaceManagerRegular(String localHost, List<String> keyspacesLocal, Set<String> keyspacesRemote,
